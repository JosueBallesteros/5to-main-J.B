...
<div class="card">
    <button type="button" class="btn btn-outline-secondary" onclick="LimpiarCajas()" 
            ...
            <form id="form_clientes" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="correo_electronico" id="correo_electronico" class="form-control" placeholder="Ingrese correo">
                    </div>
                </div>
